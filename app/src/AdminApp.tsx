...
import FormBuilders from './components/formBuilder/FormBuilders';
                    ...
                    <Navbar variant={'dark'} collapseOnSelect expand={'lg'}>
                        ...
                        <Navbar.Collapse id={'responsive-navbar-nav'}>
                            <Nav variant={'pills'} className={'flex-column'}>
                                ...
                                <Nav.Link as={NavLink} to={'/form-builder'}>{lang['menu-form-builder']}</Nav.Link>
                ...
                <div className={'app-col'}>
                    <Container>
                        ...
                        <Switch>
                            ...
                            <AuthorisedRoute path={'/form-builder'} component={FormBuilders} />
